...
fho_e_m     = 776.4;         % common Morse well depth / k_B [K]
fho_steric2 = 0.002612;      % VT2 steric factor
fho_steric4 = 0.028546;      % VT4 steric factor
...
AD.use_vv34_2d = true;          % set false to remove VV^d_{3-4,2}
AD.use_vv32_4d = true;          % set false to remove VV^d_{3-2,4}
